...
export const ElectronicsGrid3 = () => {
  const data = useStaticQuery(graphql`
    {
      picture1: file(relativePath: { eq: "electronics/qcy/qcy_girl_1.jpg" }) {
        childImageSharp {
      ...
      picture2: file(relativePath: { eq: "electronics/qcy/qcy_girl_2.jpg" }) {
        childImageSharp {
          fixed(quality: 90, width: 250, height: 250) {
            ...GatsbyImageSharpFixed
          }
      ...
      picture3: file(relativePath: { eq: "electronics/qcy/qcy_hero.jpg" }) {
        childImageSharp {
          fixed(quality: 90, width: 250, height: 250) {
            ...GatsbyImageSharpFixed
          }
      ...
      picture4: file(relativePath: { eq: "electronics/qcy/qcy_ad_1.jpg" }) {
        childImageSharp {
          fixed(quality: 90, width: 250, height: 250) {
            ...GatsbyImageSharpFixed
          }
      ...
      picture5: file(relativePath: { eq: "electronics/qcy/qcy_specs_2.jpg" }) {
        childImageSharp {
          fixed(quality: 90, width: 250, height: 250) {
            ...GatsbyImageSharpFixed
          }
      ...
      picture6: file(relativePath: { eq: "electronics/qcy/qcy_hero_3.jpg" }) {
        childImageSharp {
          fixed(quality: 90, width: 250, height: 250) {
            ...GatsbyImageSharpFixed
          }
    ...
    <Container>
      ...
      <SubDiv3>
        <ImageSquare
          ...
          title={'QCY Noise Cancels'}
        />
      </SubDiv3>
      <SubDiv4>
        <ImageSquare
          img={data.picture3.childImageSharp.fixed}
          title={'QCY Black'}
        />
      </SubDiv4>
      <SubDiv5>
