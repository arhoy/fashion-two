...
import NavElectronics2 from '../navigation/NavElectronics2';
...
const theme = {
  colors: {
    primary: 'rgb(196, 14, 14)',
    primaryDark: 'rgb(93, 6, 6)',
    primaryLight: 'rgb(218, 0, 50)',
    primaryVeryLight: 'rgb(255, 142, 167)',
